game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://17008182824";
      Title = "Dragon Hub no key", 
      Text = "No Key For Now!!",
       Button1 = "Okay pls",
  })
...
WindowStroke.Color = Color3.fromRGB(222,29,203)
...
LOGO.Name = "LOGO"
LOGO.Parent = MAIN
LOGO.BackgroundColor3 = Color3.fromRGB(222, 29, 203)
...
TITLE.Text = "Dragon Hub no key"
TITLE.TextColor3 = Color3.fromRGB(227, 77, 209)
TITLE.TextScaled = true
TITLE.TextSize = 14.000
TITLE.TextWrapped = true

LOADING.Name = "LOADING DRAGON HUB"
LOADING.Parent = MAIN
...
wait(1)
LOADING.Text = "LOADING DRAGON HUB"
BAR:TweenSize(UDim2.new(0, 150,0, 15), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
wait(1)
LOADING.Text = "DRAGON HUB hello " ..game.Players.LocalPlayer.DisplayName.. " From: ".. code
...
wait(1)
LOADING.Text = "Script Dragon Hub no key"
...
local Tabs = {
    profile = Window:AddTab({ Title = "Tab information", Icon = "swords" }),
    Main = Window:AddTab({ Title = "Tab Main", Icon = "swords" }),
    Setting = Window:AddTab({ Title = "Tab Setting", Icon = "swords" }),
    Status = Window:AddTab({ Title = "Tab Server", Icon = "swords" }),
    Stats = Window:AddTab({ Title = "Tab Stats", Icon = "swords" }),
    Player = Window:AddTab({ Title = "Tab Player", Icon = "swords" }),
    Teleport = Window:AddTab({ Title = "Tab Teleport", Icon = "swords" }),
    Fruit = Window:AddTab({ Title = "Tab Fruit blox Esp", Icon = "swords" }),
    Raid = Window:AddTab({ Title = "Tab Dungeon", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Tab Race V4", Icon = "swords" }),
    Shop = Window:AddTab({ Title = "Tab Shop", Icon = "swords" }),
	Misc = Window:AddTab({ Title = "Tab Miscellaneous", Icon = "swords" }),
    Hop = Window:AddTab({ Title = "Tab Hop", Icon = "swords" }),
}
...
ImageButton.Image = "http://www.roblox.com/asset/?id=17008182824"
...
local listfastattack = {'Normal','Slow','Super','Low','speed','Extra'}
    ...
    _G.FastAttackWinterhub_Mode = Value
	...
	elseif _G.FastAttackWinterhub_Mode == "Low" then
		_G.Fast_Delay = 0.018	
	elseif _G.FastAttackWinterhub_Mode == "Speed" then
		_G.Fast_Delay = 0.009	
	elseif _G.FastAttackWinterhub_Mode == "Extra" then
		_G.Fast_Delay = 0.001
	end
end)
    ...
    spawn(function()
        ...
        local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "Auto Farm Candy",Description = "", Default = false })
...
Tabs.Main:AddButton({
    Title = "Auto Farm Chest Vip ON",
    Description = "stop when yes item/dừng khi có vật phẩm",
    Callback = function()
        _G.JoinTeam = "Pirates"
        _G.Stop_If_Has_Items = true
        loadstring(game:HttpGet("https://shz.al/~winterfarmchestupdate"))()
    end
})
...
spawn(function()
    pcall(function()
      ...
      local ToggleEspKitsune = Tabs.Main:AddToggle("ToggleEspKitsune", {Title = "Esp Kitsune Event Island",Description = "", Default = false })
...
local SpeedBoatToggle = Tabs.Main:AddToggle("SpeedBoat_Toggle", {Title = "Auto Speed Boat",Description = "", Default = false })
...
game:GetService("RunService").RenderStepped:Connect(function()
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark 20%",Description = "", Default = false })
    ...
    local ToggleShip = Tabs.Main:AddToggle("ToggleShip", {Title = "Auto Kill Ship",Description = "", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Main:AddToggle("ToggleGhostShip", {Title = "Auto Kill Ghost Ship",Description = "",Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Auto kill Sea Beast",Description = "", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Auto hang Mirage Island",Description = "", Default = false })
...
spawn(function()
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Enabled Bring Mob / Magnet",Description = "fix gom quái", Default = true })
...
Tabs.profile:AddParagraph({
        Title = "bản update 1.1",
        Content = "beta"
    })
    
 Tabs.profile:AddParagraph({
        Title = "Wibu làm nên thương hiệu",
        Content = "hahahaha"
    })   
--------------------------------------------------------------------------------------------------------------------------------------------
--Hop
...
warn("Cảm ơn bạn đã sử dụng hack Winter")
